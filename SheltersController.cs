...
namespace ShelterInfrastructure.Controllers
{
    public class SheltersController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            //var shelterName = _context.Shelters
            //    .Where(c => c.ShelterId == id)
            //    .Select(c => c.ShelterName)
            //    .FirstOrDefault();
        ...
        // GET: Shelters/CreateAnimal
        //public IActionResult CreateAnimal(int shelterId, string shelterName)
        //{
        //    ViewBag.ShelterId = shelterId;
        //    ViewBag.ShelterName = shelterName;
        //    return View("Create", new Animal { ShelterId = shelterId });
        //}
